      ...
      <div className="w-full  px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-8 sm:gap-12 ">
          ...
          <div className="flex-1 min-w-0">
            ...
            <h2 className="text-[#E6A23C] text-[clamp(1.5rem,5vw,4rem)]">
              Why Choose Us ?
            </h2>

            <p className="mt-4 text-gray-500 leading-relaxed text-[clamp(0.9rem,2vw,1.1rem)]">
              Your pet's health and well-being are our top priority.
            </p>

            {/* FEATURES */}
            <div className="mt-8 sm:mt-10 lg:mt-12 grid grid-cols-1 sm:grid-cols-2 gap-x-8 sm:gap-x-10 lg:gap-x-12 gap-y-6 sm:gap-y-8 lg:gap-y-10">
              ...
              {[ 
                ...
                <div key={index} className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0">
                    <h4 className="font-semibold text-gray-900 text-[clamp(0.9rem,1.8vw,1.1rem)]">
                      {item[0]}
                    </h4>
