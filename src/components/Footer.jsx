...
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-r from-blue-400 via-purple-400 to-orange-400  px-4 py-10">
      {/* MAIN FOOTER CARD */}
      <div className="flex mx-w-auto rounded-3xl md:justify-space-between bg-white p-6  sm:p-10 2xl:p-18 lg:p-14">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 w-full   lg:grid-cols-4">

          {/* LOGO + DESC */}
          <div>
            <h2 className="text-3xl 2xl:text-5xl font-bold text-[#D9A441]">Wellfetch</h2>
            <p className=" mt-3 mx-auto text-gray-400
          ...
          <div className=" 2xl:ml-[40%]">
            <h4 className="mb-4 text-sm font-semibold 2xl:text-4xl uppercase text-gray-800">
              Quick Links
            </h4>
            <ul className="space-y-3  mt-3 mx-auto text-gray-400
              max-w-[clamp(28rem,45vw,70rem)]
          ...
          {/* HELP */}
          <div className=" 2xl:ml-[40%]">
            <h4 className=" mb-4 text-sm 2xl:text-4xl font-semibold uppercase text-gray-800">
              Help
            </h4>
            <ul className="space-y-3  text-[clamp(0.9rem,1.4vw,2rem)] text-gray-500">
          ...
          <div className=' lg:flex flex-col items-center gap-[clamp(1rem,2vw,2rem)] py-2'>
            ...
            <p className=" py-2 text-[clamp(0.85rem,2vw,1.3rem)]">(+999) 999-99-99</p>
            <p className="py-2  text-[clamp(0.85rem,2vw,1.3rem)]">info@wellfetch.com</p>

            <p className="py-2  text-[clamp(0.85rem,1.4vw,1.5rem)]">
      ...
      {/* GRADIENT STRIP */}
        ...
        <div className="flex mt-12 flex-col gap-6 lg:flex-row md:flex-row lg:items-center lg:justify-between">
          ...
          <h3 className="w-full text-2xl font-semibold  text-[clamp(1rem,1.5vw,4rem)]  text-white">
            Get 10% off your first order plus expert dog health tips.
          </h3>

          <div className= "  relative mt-10 flex w-full  text-[clamp(1rem,1.5vw,2rem)] items-center rounded-[18px] border-[2px solid white] bg-white/20 px-4 py-5 backdrop-blur">
          <h2 className='absolute bottom-25 2xl:bottom-30 z-100 font-bold text-white' >Join The Pack</h2>
          <p 
      className="absolute top-[-clamp(1rem,1vw,2.2rem)] left-[clamp(1rem,2vw,2rem)] text-[clamp(0.75rem,1vw,1rem)] 2xl:text-[clamp(0.75rem,1vw,1.5rem)] bottom-20 text-gray-200 font-semibold uppercase"
    >
      YOUR EMAIL
    </p>
            <input
