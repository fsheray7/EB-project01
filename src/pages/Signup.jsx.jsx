        ...
        <main className="flex flex-1 items-center justify-center px-4 sm:px-6 md:px-8 py-2 sm:py-8 md:py-10 2xl:px-10 2xl:py-14">
          <div className="w-full max-w-sm sm:max-w-md md:max-w-lg 2xl:max-w-xl lg:max-w-lg bg-gray-10 hover:shadow-lg transition-shadow duration-300">
            <div className="w-full bg-gray-10 text-start px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-10 2xl:px-10 2xl:py-14">
              {/* HEADINGS */}
              <h1 className="text-xltext-xl sm:text-2xl md:text-5xl 2xl:text-5xl   text-gray-900">Hello,</h1>
              ...
              <form className="space-y-4 sm:space-y-5 md:space-y-6 2xl:space-y-10 text-left">
                {/* NAME */}
                <div>
                  <label className="block mb-2 text-xs sm:text-sm text-gray-900 2xl:text-2xl font-bold">Name</label>
                  <input
                    type="text"
                    placeholder="Jack"
                ...
                <div>
                  <label className="block mb-2 text-xs sm:text-sm text-gray-900 2xl:text-2xl font-bold">Mobile Number</label>
                  <input
                    type="number"
              ...
              {/* FOOTER */}
              <div className="text-center py-4 mt-6 sm:mt-8 md:mt-10 text-xs  sm:text-md md:text-lg lg:text-xl 2xl:text-xl text-gray-500">
                <p className="mt-6 sm:mt-8 md:mt-10 text-md sm:text-sm md:text-md lg:text-md 2xl:text-lg text-center  text-gray-500">
