...
export default function PausedSubscriptions() {
  return (
      ...
      <div className="flex w-full flex-col  lg:flex-row lg:items-center gap-7">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3 text-xs text-[#00000080]">
          ...
          <div className="flex items-center justify-center flex-wrap gap-6 mt-6">
            ...
            <button className="flex items-center gap-2 text-xs px-3 py-2 font-semibold rounded-full border border-[#4C9E84] text-[#4C9E84]"> <span><FaPlay className="text-sm " /></span>
              Resume Order
            </button>
